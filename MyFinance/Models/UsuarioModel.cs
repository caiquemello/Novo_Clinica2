...
namespace MyFinance.Models
{
    public class UsuarioModel
    {
        ...
        {
            string sql = $"SELECT ID,CPF,NOME, DATA_NASCIMENTO FROM USUARIO WHERE EMAIL='{Email}' AND SENHA='{Senha}'";
            DAL objDAL = new DAL();
        ...
        public void RegistrarUsuario()
        {
            ...
            string sql = $"INSERT INTO USUARIO (CPF,NOME, EMAIL, SENHA, DATA_NASCIMENTO) VALUES('{CPF}','{Nome}','{Email}','{Senha}','{dataNascimento}')";
            DAL objDAL = new DAL();
